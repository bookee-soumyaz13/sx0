...
This document describes the algorithms, scoring heuristics, and concurrency strategies behind sx0's ultra-fast fuzzy file finder ([`fuzzy.go`](../../fuzzy.go)).
...
sx0 solves this with a Two-Pass Bounded Search Algorithm:
