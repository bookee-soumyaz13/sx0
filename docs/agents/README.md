...
| Browser typing / Save                | `save.go`, `web/src/edit.js`                                     | [`docs/internals/browser-editing.md`](../internals/browser-editing.md), [`docs/features/browser-editing.md`](../features/browser-editing.md), [`README.md`](../../README.md) |
...
| `web/src/edit.js`      | In-browser typing and `POST /api/save`: load raw buffer, insert/delete, undo/redo, dirty tabs, vim insert bridge. |
