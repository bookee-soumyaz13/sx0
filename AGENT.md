...
- Comprehensive Guidelines: See [`docs/agents/README.md`](docs/agents/README.md) for:
  1. Core Architectural Tenets: Reads-first design; optional in-browser save gated like agent edits; zero-runtime static binary; zero disk state in the workspace; bounded concurrency budgets.
