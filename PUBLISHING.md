...
This document outlines the step-by-step instructions for preparing, testing, and publishing a new release of `sx0`.

## 1. Prerequisites

Before cutting a new release, ensure you have:

- Git with push and tag permissions for `sx0-ai/sx0`.
- Go (version 1.24+).
...
1. Navigate to Actions -> Release on GitHub: `https://github.com/sx0-ai/sx0/actions/workflows/release.yml`
...
1. Confirm artifacts on the [Releases](https://github.com/sx0-ai/sx0/releases) page (cross-platform binaries and `checksums.txt`). The self-updater requires this file and verifies the selected binary against it before execution.
