...
Thank you for your interest in improving sx0.

## AI-Driven Development and Contributions

sx0 is built and maintained entirely using AI coding agents.
...
- Check existing [GitHub Issues](https://github.com/sx0-ai/sx0/issues) first to avoid duplicates.
...
- Explain the motivation: what problem does this solve, why would it benefit users, and how would it fit sx0's reads-first, minimal-footprint philosophy?

## Review and Implementation Process

1. Review: Maintainers evaluate every issue against sx0's design philosophy (simplicity, single-binary distribution, minimal resource consumption, speed).
...
Thank you for helping make sx0 better.
